...
namespace Hudayim.Uyelik.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly UyelikDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = UyelikConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(UyelikDbContext context)
        {
            _context = context;
        }
