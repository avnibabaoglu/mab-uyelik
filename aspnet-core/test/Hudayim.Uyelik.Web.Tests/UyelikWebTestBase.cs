...
namespace Hudayim.Uyelik.Web.Tests
{
    public abstract class UyelikWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static UyelikWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(UyelikWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<UyelikDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<UyelikDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<UyelikDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<UyelikDbContext, Task<T>> func)
        {
            T result;
